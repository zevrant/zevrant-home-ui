...
CMD  echo "aws_access_key_id = $ACCESS_KEY" >> ~/.aws/credentials; echo "aws_secret_access_key = $SECRET_KEY" >> ~/.aws/credentials; java -jar /usr/local/microservices/zevrant-home-services/zevrant-home-ui/zevrant-home-ui.jar
