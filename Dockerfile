...
RUN apt-get install -y postgresql-client dnsutils
...
CMD mkdir -p ~/.aws; echo "[default]" > ~/.aws/credentials\
 ...
 && java -Xmx32G -jar -Dspring.profiles.active=prod /usr/local/microservices/zevrant-home-services/zevrant-home-ui/zevrant-home-ui.jar
